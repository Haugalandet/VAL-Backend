...
import no.haugalandplus.val.auth.AuthService;
...
public class AuthController {
    ...
    public AuthController(AuthService authService, JwtTokenUtil jwrTokenUtil) {
    ...
    public ResponseEntity<String> login(@RequestBody LoginDTO user) {
        ...
        headers.add("Authorization", authService.createToken(user));
    ...
    public ResponseEntity<String> login() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization", authService.createToken());
